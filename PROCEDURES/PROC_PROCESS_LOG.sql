--------------------------------------------------------
--  DDL for Procedure PROC_PROCESS_LOG
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "ASB_STG"."PROC_PROCESS_LOG" 
/**************************************************************************************
*
...
*
**************************************************************************************/
(pi_proc_name IN VARCHAR2,pi_load_seq_nbr IN NUMBER,pi_status IN VARCHAR2,pi_error IN VARCHAR2,p_ENTITY_NAME IN VARCHAR2)
AS
BEGIN

    INSERT INTO PROCESS_LOG (PROC_SEQ_NBR, PROC_NAME, LOAD_SEQ_NBR, STATUS, STATUS_DESCRIPTION, DATE_CREATED,ENTITY_NAME)
    VALUES(SQ_PROC_SEQ_NBR.nextval,pi_proc_name,pi_load_seq_nbr,pi_status,pi_error,SYSDATE,p_ENTITY_NAME);
