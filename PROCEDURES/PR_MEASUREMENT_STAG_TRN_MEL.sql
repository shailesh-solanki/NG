--------------------------------------------------------
--  DDL for Procedure PR_MEASUREMENT_STAG_TRN_MEL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "ASB_STG"."PR_MEASUREMENT_STAG_TRN_MEL" (PI_LOAD_SEQ_NBR IN NUMBER)AS
/**************************************************************************************
*
* Program Name           :PR_MEASUREMENT_STAG_TRN_MEL
* Author                 :IBM(Shailesh Solanki)
* Creation Date          :06-09-2021
* Description            :This is a PL/SQL procedure. This procedure transfer MEL operational data
...
BEGIN
 ...
 USING (SELECT MEASR_COMP_ID,MSRMT_DTTM,BO_STATUS_CD,MSRMT_COND_FLG,MSRMT_USE_FLG,MSRMT_LOCAL_DTTM,MSRMT_VAL,ORIG_INIT_MSRMT_ID,PREV_MSRMT_DTTM
        ,MSRMT_VAL1,MSRMT_VAL2,MSRMT_VAL3,MSRMT_VAL4,MSRMT_VAL5,MSRMT_VAL6,MSRMT_VAL7,MSRMT_VAL8,MSRMT_VAL9,MSRMT_VAL10,BUS_OBJ_CD,CRE_DTTM,
         STATUS_UPD_DTTM,USER_EDITED_FLG,VERSION,LAST_UPDATE_DTTM,READING_VAL,COMBINED_MULTIPLIER,READING_COND_FLG FROM MSM_STG2.D1_MSRMT_MEL) S1
...
--PR_DATA_MIGRATION_COUNT(pi_load_seq_nbr,'PR_MEASUREMENT_STAG_TRN_MEL','D1_MSRMT');
...
END PR_MEASUREMENT_STAG_TRN_MEL;
